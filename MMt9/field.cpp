...
bool Field::match(String packet) {
    ...
    ////data_pattern[0] = src-ip - will use it for know looking packet is src or dst
    /// data_pattern[1] = XXX.XXX.XXX.XXX/3
    String* data_pattern;
    ...
    data_pattern[FORMAT] = data_pattern[FORMAT].trim();
...
/// data_address[1] = XXX.XXX.XXX.XXX
    ...
    for(size_t i=0 ; i < addresses_cnt; i++) {
        ...
        if( data_address[FORMAT].equals( data_pattern[FORMAT] ) ){
